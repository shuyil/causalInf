function [rating,onset,resp_end] = rateCause(window, scan, imageSource, effectSource, stiCoor, coCoor, xCenter, barRect, barWidth, MarkerXPos, labelPos, IO, ioObj, address)
