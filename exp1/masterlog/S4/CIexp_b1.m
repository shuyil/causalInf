...
for trial = 1:3
    ...
    data.output.s1_order(trial,1) = schedule.order(trial,1);
    if data.output.s1_order(trial,1) == 1
    ...
    data.output.s2_order(trial,1) = schedule.order(trial,2);
    if data.output.s2_order(trial,1) == 1
